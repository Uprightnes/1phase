            ...
            <table id="staffTable" class="table table-striped table-bordered table-hover">
                ...
                @foreach($redeploy as $item)
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-success edit-btn" data-id="{{$item->id}}" data-toggle="modal" data-target="#editModal">Edit</button>
                            <button type="button" class="btn btn-success deploy-btn" data-id="{{$item->id}}"  data-target="#staffTable">Deploy</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
